...
async function getAMC8Data(chunkDone) {
  ...
  for (let contestLink of contestLinks) {
    ...
    // console.log("Getting " + serializedContestTitle + "...")
		// if (serializedContestTitle !== "2022_AMC_8") continue;
    ...
    const problemLinks = contestProblemListDOM.window.document.querySelectorAll("li > ul > li > a")
